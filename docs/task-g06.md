...
|---|---|---|---|
| M1 — DB 마이그레이션 + 호환 검증 | 4일 | 🔄 | 1/3 |
| M2 — 라우팅 모듈 (Stage 0~2) + /api/legend/route | 6일 | 🔄 | 0/4 |
...
### G06-06: Stage 2 (Ramanujan probe) + escalation-detector + legend-router 통합
- **선행**: G06-05
- **변경 파일**:
...
### G06-09: fallback 매트릭스 (Gemini 429 자동 전환 포함)
- **선행**: G06-08
- **변경 파일**:
...
### G06-16: report-builder + /api/legend/report 라우트 5종
...
### G06-18: PerProblemReportCard + StepDecompositionView + TriggerExpansionCard
- **선행**: G06-16, G06-17
- **변경 파일**:
...
### G06-20: LLMStruggleSection ⭐ Δ3 + 나머지 6 컴포넌트
- **선행**: G06-19
- **변경 파일**:
