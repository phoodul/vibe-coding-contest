...
## 역할
학생의 프로필(MBTI, 취미, 적성, 독서 성향, 성적 분포, 운동능력, 관심분야)을 종합 분석하여 최적의 직업과 진로 경로를 추천합니다.
...
## 출력 형식
JSON 형식으로 출력하되, 먼저 학생 프로필 분석 요약을 제공한 후 추천 목록을 나열합니다.
`;
...
export const ASSESSMENT_FIELDS = [
  ...
  },
  {
    ...
    label: "운동 능력 / 체육 활동",
    type: "text" as const,
    placeholder: "예: 축구 교내 대표, 체육 보통, 마라톤 참가...",
  },
];
