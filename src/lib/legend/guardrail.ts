...
const CRISIS_MESSAGE = `당신의 마음이 많이 힘드시군요. 지금 이 순간 가장 중요한 것은 당신의 안전입니다. 혼자 견디지 마시고 전문가의 도움을 받아주세요.

📞 **자살예방상담전화: 1393** (24시간, 무료)
📞 **청소년상담전화: 1388** (24시간, 학생 전용)
🏫 **Wee센터**: 학교에 있는 상담 전문가
💬 **카카오톡**: 카톡 채널 "마인드포스트", "청소년사이버상담센터"

저는 수학 코칭 AI 라 여러분의 마음을 충분히 도울 수 없습니다. 하지만 위 자원들은 정말로 당신을 도울 수 있는 분들입니다. 지금 한 곳에라도 연락해주시기를 부탁드립니다. 당신은 소중한 존재이며 도움을 받을 자격이 있습니다.`;
