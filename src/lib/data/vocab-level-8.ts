...
export const LEVEL_8: VocabGroup[] = [
  ...
  },
  {
    ...
    words: [
      ...
      ["Fermat theorem", "페르마 정리"],
      ["Euler totient", "오일러 토션트"],
  ...
  },
  {
    ...
    words: [
      ...
      ["Helsinki Declaration", "헬싱키 선언"],
      ["Nuremberg Code", "뉘른베르크 강령"],
      ["Belmont Report", "벨몬트 보고서"],
      ["Tuskegee experiment", "터스키기 실험"],
      ["neuroethics", "신경윤리학"],
