...
9. Markdown 코드펜스 없이 순수 Markdown 텍스트만 출력]`,
  ...
  function startMaterialLesson() {
    ...
    const depthGuide = learningDepth === "overview"
      ? `## 학습 모드: 개요 (많은 내용을 빠르게, 약 25~30분)
- 주어진 자료의 내용을 최대한 많이 커버합니다. 목표: 5~10개 개념.
- 각 개념당 1~2턴, 핵심만 짚고 넘어갑니다.
- "이게 뭔지, 왜 중요한지, 언제 쓰는지"에 집중합니다.
- 코드나 설정 세부사항은 생략하고 큰 그림을 그려줍니다.
- 학생이 이미 알고 있는 개념이면 확인 후 바로 다음으로 넘어가세요. 시간에 얽매이지 마세요.`
      : `## 학습 모드: 실무 (적은 내용을 깊게, 약 25~30분)
