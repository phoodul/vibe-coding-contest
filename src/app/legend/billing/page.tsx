...
export default function LegendBillingPage() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-violet-950 text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 md:py-16">
        <div className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-bold">레전드 튜터 구독</h1>
          <p className="text-sm text-white/60 mt-2">정답을 가르치지 않는 코치를 무제한으로 만나세요.</p>
          <p className="text-xs text-white/40 mt-1">
            <Link href="/legend" className="underline hover:text-white">
              ← 채팅으로 돌아가기
            </Link>
          </p>
        </div>
