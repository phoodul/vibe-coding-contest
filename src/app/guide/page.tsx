...
const studentTools = [
  ...
  { icon: "🏛️", title: "Legend Tutor", desc: "라마누잔·가우스·폰 노이만·오일러·라이프니츠 5거장 AI. 학년·과목별 코칭과 수능 기출 연습 모드." },
...
const detailedGuides = [
  {
    title: "Legend Tutor 사용법",
    icon: "🏛️",
    steps: [
      "학년·과목 선택 — 중1~기하벡터 9개 카테고리 중에서 학습할 영역을 고릅니다.",
      "거장 튜터 선택 — 라마누잔·가우스·폰 노이만·오일러·라이프니츠 중에서 함께할 5거장을 선택합니다.",
      "문제 입력 또는 기출 연습 — 문제 사진/필기/텍스트로 직접 풀거나, 수능·모의고사 기출 연습 탭에서 선택해 풀이합니다.",
      "AI 코칭 — 정답을 바로 알려주지 않고, 단계별 힌트와 trigger 패턴으로 사고를 이끕니다.",
    ],
  },
  {
    title: "소크라테스 튜터 사용법",
