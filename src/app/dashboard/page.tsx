...
const studentItems: MenuItem[] = [
  ...
  { title: "Physics Maestro", desc: "수능 물리학Ⅰ·Ⅱ 문제풀이 가이드 — 4 명의 거장", icon: "⚛️", href: "/physics" },
  { title: "Chemistry Maestro", desc: "수능 화학Ⅰ·Ⅱ 문제풀이 가이드 — 4 명의 거장", icon: "🧪", href: "/chemistry" },
  { title: "Biology Maestro", desc: "수능 생명과학Ⅰ·Ⅱ 문제풀이 가이드 — 4 명의 거장", icon: "🧬", href: "/biology" },
  { title: "Earth Science Maestro", desc: "수능 지구과학Ⅰ·Ⅱ 문제풀이 가이드 — 4 명의 거장", icon: "🌍", href: "/earth-science" },
